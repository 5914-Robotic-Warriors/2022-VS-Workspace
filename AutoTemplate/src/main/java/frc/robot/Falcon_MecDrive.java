...
class Falcon_MecDrive extends Robot {
    ...
    Falcon_MecDrive()  {
        ...
        WPI_TalonFX frontLeft = new WPI_TalonFX(constants.frontLeftDrive);
        WPI_TalonFX frontRight = new WPI_TalonFX(constants.frontRightDrive);
        WPI_TalonFX backLeft = new WPI_TalonFX(constants.backLeftDrive);
        WPI_TalonFX backRight = new WPI_TalonFX(constants.backRightDrive);
