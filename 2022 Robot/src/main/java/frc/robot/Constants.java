...
public class Constants extends Robot {
    ...
    final int Left_Trigger_Button = 7;
    final int Right_Trigger_Button = 8;
    ...
    final int shootLow = 9;
    final int shootHigh = 10;
    final int intakeMotor = 11;
    
    final int pneumHub = 8;

    // Pneumatics IDs
    final int midRungIn = 8; //CORRECT
    final int midRungOut = 7; //CORRECT
    final int highRungIn = 5; //CORRECT
    final int highRungOut = 10; //CORRECT
    final int travRungIn = 9; //CORRECT
    final int travRungOut = 6; //CORRECT
}
