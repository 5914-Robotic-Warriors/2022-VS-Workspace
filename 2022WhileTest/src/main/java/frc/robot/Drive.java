...
class Drive extends Robot {
    ...
    int invertDriveState;
    int normal = 1;
    int inverted = 2;
    boolean invertDriveEnabled = false;
    ...
    Drive() {
        ...
        invertDriveState = normal;
    }

    public void invertDrive() {
        if ((stick.getRawButton(constants.Share_Button) == true)
                && (invertDriveState == normal) && (invertDriveEnabled == true)) {
            driveInverted = true;
            invertDriveState = inverted;
            invertDriveEnabled = false;
            System.out.println("Invert Drive State = " + invertDriveState);
            delay.delay_milliseconds(20);
        } else if ((stick.getRawButton(constants.Share_Button) == true)
                && (invertDriveState == inverted) && (invertDriveEnabled == true)) {
            ...
            System.out.println("Invert Drive State = " + invertDriveState);
            delay.delay_milliseconds(20);
        } else if ((stick.getRawButton(constants.Share_Button) == false)
                && (invertDriveEnabled == false)) {
            System.out.println("Button Released, State = " + invertDriveState);
            invertDriveEnabled = true;
            delay.delay_milliseconds(20);
        }
    }
